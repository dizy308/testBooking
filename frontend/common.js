...
export function calculatePx(chosenObject,{startHour,endHour,startCalendar,endCalendar}, calculateType=""){
...
export function createHeader(headerPos, startHour, endHour){
